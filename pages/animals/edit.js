  ...
  return (
    <>
      <main className={`grid grid-rows-6 h-full`}>
        <div className={`relative bg-gray-400 row-span-3`}>
          <img
            ...
            alt="" />
          <div className={`absolute bottom-5 right-5 scale-125`}>
            <BiPen className={`text-4xl text-green-600 bg-white rounded-full p-2`} />
          </div>
        </div>
